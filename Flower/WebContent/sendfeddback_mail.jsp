...
<% 
String receiverEmailId	= "varun.saddi@newgen.co.in";
String userName	= request.getParameter("name");
String userEmail	= request.getParameter("email");
String userComment	= request.getParameter("comment");

String eMails	= receiverEmailId;
...
String password="approach123#";////Password
...
{									
		...
		contentsHtml= contentsHtml + "User has send some feddback.\n\n";
		contentsHtml= contentsHtml + "Name=" + userName + "\n\n" ;
		contentsHtml= contentsHtml + "Email=" + userEmail + "\n\n" ;
		contentsHtml= contentsHtml + "Comment=" + userComment ;
